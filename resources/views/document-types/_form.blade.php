<form class="resource-form" method="POST" action="{{ $action }}">
    ...
    <div class="form-grid">
        <label class="field">
            ...
            <input type="text" name="name_uz" value="{{ old('name_uz', $documentType->name_uz) }}" placeholder="Buyruq" required>
            @error('name_uz')
        ...
        <label class="field">
            ...
            <input type="text" name="name_ru" value="{{ old('name_ru', $documentType->name_ru) }}" placeholder="Приказ" required>
            @error('name_ru')
                <span class="field-error">{{ $message }}</span>
            @enderror
        </label>
    ...
    <div class="form-actions">
        <a class="btn btn--ghost" href="{{ route('document-types.index') }}">Bekor qilish</a>
