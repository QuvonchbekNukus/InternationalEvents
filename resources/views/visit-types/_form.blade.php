<form class="resource-form" method="POST" action="{{ $action }}">
    ...
    <div class="form-grid">
        ...
        <label class="field field--span-2">
            ...
            <input type="text" name="name_cryl" value="{{ old('name_cryl', $visitType->name_cryl) }}" placeholder="Расмий ташриф" required>
            @error('name_cryl')
                <span class="field-error">{{ $message }}</span>
            @enderror
        </label>
    ...
    <div class="form-actions">
        <a class="btn btn--ghost" href="{{ route('visit-types.index') }}">{{ __('ui.common.actions.cancel') }}</a>
